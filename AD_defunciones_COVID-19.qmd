...
cov_ComAut = filter(tb_cov, Sexo == "Total", Comunidades.y.Ciudades.Autónomas != "", Covid.19 == "Total", Semana.de.defunción == "Total")
```
...
```
```{r,echo=FALSE}
cov_Ident = filter(tb_cov, Sexo == "Total", Comunidades.y.Ciudades.Autónomas == "", Covid.19 == "Covid-19 Virus identificado")

cov_No.Ident = filter(tb_cov, Sexo == "Total", Comunidades.y.Ciudades.Autónomas == "", Covid.19 == "Covid-19 Virus no identificado (sospechoso)")

cov_SIM.Cv19 = filter(tb_cov, Sexo == "Total", Comunidades.y.Ciudades.Autónomas == "", Covid.19 == "Síndrome inflamatorio multisistémico asociado con COVID-19, no especificado")
```
